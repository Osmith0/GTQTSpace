package keqing.gtqtspace.client.render.items;
...
import keqing.gtqtspace.common.items.ItemsInit;
...
public class RenderItemAdvancedRocket extends TileEntityItemStackRenderer {
    public static final IModelCustom model = AdvancedModelLoader.loadModel(new ResourceLocation(GTQTSpace.MODID, "models/shipi.obj"));
    private final   ResourceLocation texture = new ResourceLocation(GTQTSpace.MODID, "models/hongbei.png");

...
import keqing.gtqtspace.jei.SpacePumpInfo;
...
public class SpacePumpCategory extends BasicRecipeCategory<SpacePumpInfo, SpacePumpInfo> {
    ...
    @Override
    public void setRecipe( IRecipeLayout recipeLayout, SpacePumpInfo spacePumpInfo,  IIngredients ingredients) {
    ...
    @Override
    public IRecipeWrapper getRecipeWrapper( SpacePumpInfo spacePumpInfo) {
    ...
    public void drawExtras( Minecraft minecraft) {
        ...
        String planetName = I18n.format("gtqtspace.jei.space_pump_planet_name", planet);
        ...
        String planetIDName = I18n.format("gtqtspace.jei.space_pump_planet_number", planetID);
        ...
        String fluidIDName = I18n.format("gtqtspace.jei.space_pump_fluid_number", fluidID);
        ...
        String fluidAmountName = I18n.format("gtqtspace.jei.space_pump_fluid_amount", TextFormattingUtil.formatNumbers(fluidAmount));

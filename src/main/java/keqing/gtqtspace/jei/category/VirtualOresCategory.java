...
import keqing.gtqtspace.jei.VirtualOresInfo;
...
public class VirtualOresCategory extends BasicRecipeCategory<VirtualOresInfo, VirtualOresInfo> {
    ...
    @Override
    public void setRecipe(IRecipeLayout recipeLayout, VirtualOresInfo recipeWrapper,  IIngredients ingredients) {
    ...
    @Override
    public IRecipeWrapper getRecipeWrapper( VirtualOresInfo recipe) {
        return recipe;
    }

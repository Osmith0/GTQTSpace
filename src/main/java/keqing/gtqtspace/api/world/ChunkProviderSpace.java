...
public abstract class ChunkProviderSpace extends ChunkProviderBase
{
        ...
        for (int x = 0; x < CHUNK_SIZE; x++)
        {
            for (int z = 0; z < CHUNK_SIZE; z++)
            {
                ...
                for (int y = 0; y < 255; y++)
                {
                    ...
                    {
                        primer.setBlockState(x, y, z, this.getStoneBlock());
                    }
                }
            }
        }
    ...
    public void replaceBiomeBlocks(int x, int z, ChunkPrimer primer, Biome[] biomesIn)
    {
        ...
        for (int var8 = 0; var8 < 16; ++var8)
        {
            for (int var9 = 0; var9 < 16; ++var9)
            {
                ...
                int var13 = -1;
                IBlockState var14 = this.getGrassBlock();
                IBlockState var15 = this.getDirtBlock();
                    ...
                    } else
                    {
                        ...
                        } else if (var18 == this.getStoneBlock().getBlock())
                        {
                            ...
                            if (var13 == -1)
                            {
                                if (var12 <= 0)
                                {
                                    var14 = Blocks.AIR.getDefaultState();
                                ...
                                if (var16 >= var5 - 1)
                                {
                                    primer.setBlockState(var8, var16, var9, var14);
                                } else
                                {
                                    primer.setBlockState(var8, var16, var9, var15);
                                }
                            } else if (var13 > 0)
                            {
                                --var13;
    ...
    public Chunk generateChunk(int x, int z)
    {
        ...
        {
            GTQTSLog.logger.error("Error caught in planetary worldgen at coords " + x + "," + z + ".  If the next 2 lines are showing an Add-On mod name, please report to that mod's author!");
            e.printStackTrace();
        }
     ...
     *         block.
     */
    protected abstract IBlockState getGrassBlock();
     ...
     */
    protected abstract IBlockState getDirtBlock();

...
import keqing.gtqtspace.world.biome.biomes.BiomeGenVenusValley;
import keqing.gtqtspace.world.worldgen.BiomeAdaptive;
import keqing.gtqtspace.world.worldgen.mapGen.*;
...
public class ChunkProviderVenus extends ChunkProviderBase
{
    ...
    public static final IBlockState BLOCK_FILL = GTQTSMetaBlocks.GTQTS_STONE_BLOCKS.get(GTQTSStoneVariantBlock.StoneVariant.SMOOTH).getState(GTQTSStoneVariantBlock.StoneType.VENUS);

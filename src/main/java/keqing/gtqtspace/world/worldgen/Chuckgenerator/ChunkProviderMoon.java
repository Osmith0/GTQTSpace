...
import keqing.gtqtspace.api.world.gen.EnumCraterSize;
...
import keqing.gtqtspace.world.worldgen.mapGen.MapGenCavesMoon;
...
import static keqing.gtqtspace.common.block.blocks.GTQTSMoonBlock.BlockType.*;
import static keqing.gtqtspace.world.biome.GTQTSBiomeHandler.MOON_BIOME;

public class ChunkProviderMoon extends ChunkProviderBase {

    protected static final IBlockState BLOCK_TOP = GTQTSMetaBlocks.moonBlock.getState(MOON_TURF);
    protected static final IBlockState BLOCK_FILL = GTQTSMetaBlocks.moonBlock.getState(MOON_DIRT);
    protected static final IBlockState BLOCK_LOWER = GTQTSMetaBlocks.GTQTS_STONE_BLOCKS.get(GTQTSStoneVariantBlock.StoneVariant.SMOOTH).getState(GTQTSStoneVariantBlock.StoneType.MOON);
    ...
    public Chunk generateChunk(int x, int z) {
        ...
        final byte b = (byte) Biome.getIdForBiome(MOON_BIOME);
